...
export { CONTRACT_VERSION_V1, CONTRACT_VERSION_V2, DEFAULT_AUTH_SCOPES, DEFAULT_SANDBOX, DEFAULT_TOKEN_TYPE, DEVICE_AUTH_SCOPE, ECDsaPoPCryptoProvider, SIGNING_POLICY_VERSION, XboxAuthenticationClient, XboxEndpoints, base64Decode, base64Encode, base64UrlDecode, base64UrlEncode, createProofKey, getUserHash, hasAccessToken, hasRefreshToken, hasToken, isSISUAuthorizationError, isSISUAuthorizationSuccess, normalizeDisplayClaims, normalizeToArray };
